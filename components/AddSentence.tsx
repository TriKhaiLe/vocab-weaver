...
export const AddSentence: React.FC<AddSentenceProps> = ({ addSentenceEntry }) => {
  ...
  const handleSave = async () => {
    if (!vietnameseSentence || !englishSentence) {
      setError('Missing information. Please generate a sentence before saving.');
      return;
    }
  ...
  return (
    <div className="space-y-8 animate-slide-up">
      ...
      <div className="space-y-4">
        <div>
          <label htmlFor="vietnamese-input" className="block text-lg font-semibold text-brand-primary mb-2">
        ...
        <div>
          <label htmlFor="guidance-input" className="block text-lg font-semibold text-brand-primary mb-2">
      ...
      {englishSentence && (
        <div className="p-6 bg-dark-card rounded-lg border border-dark-border animate-fade-in">
          <h3 className="text-lg font-semibold text-brand-primary mb-3">Suggested Translation:</h3>
